...
export const VOCABULARY_ADVERBS: Word[] = [
...
export const VOCABULARY_FINANCE: Word[] = [
  { id: 'fin1', en: 'portfolio', it: 'portafoglio', category: 'content' },
  { id: 'fin2', en: 'diversification', it: 'diversificazione', category: 'content' },
  { id: 'fin3', en: 'market', it: 'mercato', category: 'content' },
  { id: 'fin4', en: 'risk', it: 'rischio', category: 'content' },
  { id: 'fin5', en: 'geopolitical', it: 'geopolitico', category: 'content' },
  { id: 'fin6', en: 'inflation', it: 'inflazione', category: 'content' },
  { id: 'fin7', en: 'monetary policy', it: 'politica monetaria', category: 'content' },
  { id: 'fin8', en: 'growth', it: 'crescita', category: 'content' },
  { id: 'fin9', en: 'to export', it: 'esportare', category: 'content' },
  { id: 'fin10', en: 'stagnation', it: 'stagnazione', category: 'content' },
  { id: 'fin11', en: 'semiconductors', it: 'semiconduttori', category: 'content' },
  { id: 'fin12', en: 'financial statement / budget', it: 'bilancio', category: 'content' },
  { id: 'fin13', en: 'investment', it: 'investimento', category: 'content' },
  { id: 'fin14', en: 'debt', it: 'debito', category: 'content' },
  { id: 'fin15', en: 'supply chain', it: 'filiera', category: 'content' },
  { id: 'fin16', en: 'infrastructure', it: 'infrastruttura', category: 'content' },
  { id: 'fin17', en: 'electrical grid', it: 'rete elettrica', category: 'content' },
  { id: 'fin18', en: 'earnings / profits', it: 'utili', category: 'content' },
  { id: 'fin19', en: 'productivity', it: 'produttività', category: 'content' },
  { id: 'fin20', en: 'margin', it: 'margine', category: 'content' },
  { id: 'fin21', en: 'healthcare', it: 'sanità', category: 'content' },
  { id: 'fin22', en: 'manufacturing', it: 'manifattura', category: 'content' },
  { id: 'fin23', en: 'computing power', it: 'potenza di calcolo', category: 'content' },
  { id: 'fin24', en: 'economic cycle', it: 'ciclo economico', category: 'content' },
  { id: 'fin25', en: 'consumption', it: 'consumi', category: 'content' },
  { id: 'fin26', en: 'competitive advantage', it: 'vantaggio competitivo', category: 'content' },
  { id: 'fin27', en: 'energy', it: 'energia', category: 'content' },
  { id: 'fin28', en: 'defense', it: 'difesa', category: 'content' },
  { id: 'fin29', en: 'tariffs / duties', it: 'dazi', category: 'content' },
  { id: 'fin30', en: 'labor market', it: 'mercato del lavoro', category: 'content' },
  { id: 'fin31', en: 'employment', it: 'occupazione', category: 'content' },
  { id: 'fin32', en: 'wages', it: 'salari', category: 'content' },
  { id: 'fin33', en: 'central bank', it: 'banca centrale', category: 'content' },
  { id: 'fin34', en: 'interest rate', it: 'tasso di interesse', category: 'content' },
  { id: 'fin35', en: 'equities / stock market', it: 'azionario', category: 'content' },
  { id: 'fin36', en: 'volatility', it: 'volatilità', category: 'content' },
  { id: 'fin37', en: 'leverage', it: 'leva', category: 'content' },
  { id: 'fin38', en: 'fixed income', it: 'reddito fisso', category: 'content' },
  { id: 'fin39', en: 'liquidity', it: 'liquidità', category: 'content' },
  { id: 'fin40', en: 'commodities', it: 'materie prime', category: 'content' },
  { id: 'fin41', en: 'gold', it: 'oro', category: 'content' },
  { id: 'fin42', en: 'dollar', it: 'dollaro', category: 'content' },
  { id: 'fin43', en: 'futures', it: 'futures', category: 'content' },
  { id: 'fin44', en: 'inventories / stockpiles', it: 'scorte', category: 'content' },
  { id: 'fin45', en: 'oil', it: 'petrolio', category: 'content' },
  { id: 'fin46', en: 'gas', it: 'gas', category: 'content' },
  { id: 'fin47', en: 'rate hike', it: 'rialzo dei tassi', category: 'content' },
  { id: 'fin48', en: 'accommodative / dovish', it: 'accomodante', category: 'content' },
  { id: 'fin49', en: 'currency', it: 'valuta', category: 'content' },
  { id: 'fin50', en: 'bond market', it: 'mercato obbligazionario', category: 'content' },
  { id: 'fin51', en: 'issuance', it: 'emissione', category: 'content' },
  { id: 'fin52', en: 'valuation', it: 'valutazione', category: 'content' },
  { id: 'fin53', en: 'fiscal policy', it: 'politica fiscale', category: 'content' },
  { id: 'fin54', en: 'indebtedness', it: 'indebitamento', category: 'content' },
  { id: 'fin55', en: 'refined products', it: 'prodotti raffinati', category: 'content' },
  { id: 'fin56', en: 'shareholder', it: 'azionista', category: 'content' },
  { id: 'fin57', en: 'to invest', it: 'investire', category: 'content' },
  { id: 'fin58', en: 'supply', it: 'offerta', category: 'content' },
  { id: 'fin59', en: 'demand', it: 'domanda', category: 'content' },
  { id: 'fin60', en: 'capital', it: 'capitale', category: 'content' },
];
